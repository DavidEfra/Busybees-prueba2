...
<%@page import="java.sql.*" %>
        <%  
            ...
            try{
                    ...
                    String consulta = "SELECT * FROM REPORTES WHERE PERFIL = '" + perfil + "'";
	...
	<form method="post" action="cambiar_estadoINGM.jsp">
		...
		<input type="submit" class="boton1" name="guardar" value="Cambiar estado y solucion">
	</form>
